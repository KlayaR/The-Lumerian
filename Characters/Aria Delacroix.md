...
**Plot Integration:** 
- Marcus discovers asteroid material artifacts → Aria discovers engineering anomalies at same sites → Together they understand ancient installations
- Marcus can interface with technology → Aria can navigate hidden installations → Partnership required for site exploration
- Ancient sites require both pathway interface and archaeological expertise → Neither could explore them alone
